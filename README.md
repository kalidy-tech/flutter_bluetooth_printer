# KD Thermal Printer  Library

A simple and powerful Flutter library for connecting and printing to Bluetooth thermal printers from your iOS and Android applications. Easily print text, images, QR codes, and more using a friendly Dart API.

## 🚀 Features

* **Easy Device Discovery:** Scan for and connect to nearby Bluetooth printers.
* **Simple Printing API:** A straightforward and intuitive API for all your printing needs.
* **Text Formatting:** Support for different text styles (bold, underline), sizes, and alignments.
* **Image Printing:** Convert and print images on the thermal printer.
* **QR Code & Barcode Generation:** Generate and print various types of QR codes and barcodes.
* **ESC/POS Command Support:** (Optional) If your library supports raw ESC/POS commands, mention it here.
* **Cross-Platform:** Written in Dart for seamless integration with Flutter on Android and iOS.
...
This section is crucial for users to know if their printer model is likely to be compatible.

| Brand         | Model      | Status | Notes                            |
| :------------ | :--------- | :----: | :------------------------------- |
| Therminal Printer       | DP30S |   ✅   | Working. 72mm, standard ESC/POS. |
